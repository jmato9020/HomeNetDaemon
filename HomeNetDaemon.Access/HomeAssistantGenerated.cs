...
//   At: 2024-02-02T11:29:57.0492650-05:00
//
...
public static class GeneratedExtensions
{
    ...
    public static IServiceCollection AddHomeAssistantGenerated(this IServiceCollection serviceCollection)
    {
        ...
        serviceCollection.AddTransient<DeconzServices>();
        ...
        serviceCollection.AddTransient<LitterrobotServices>();
...
public partial class LightEntities
{
    ...
    ///<summary>Configuration tool 1</summary>
    public LightEntity ConfigurationTool1 => new(_haContext, "light.configuration_tool_1");
    ///<summary>Couch</summary>
    public LightEntity Couch => new(_haContext, "light.couch");
    ///<summary>Study L</summary>
    public LightEntity HueAmbianceLamp1 => new(_haContext, "light.hue_ambiance_lamp_1");
    ///<summary>Nightstand 1</summary>
    public LightEntity Nightstand1 => new(_haContext, "light.nightstand1");
    ///<summary>Nightstand 2</summary>
    public LightEntity Nightstand2 => new(_haContext, "light.nightstand2");
    ///<summary>Study</summary>
    public LightEntity Study => new(_haContext, "light.study");
    ///<summary>TV L</summary>
    public LightEntity Tvl => new(_haContext, "light.tvl");
    ///<summary>TV R</summary>
    public LightEntity Tvr => new(_haContext, "light.tvr");
}
...
public partial class BinarySensorEntities
{
    ...
    public BinarySensorEntity BackDoorDoor => new(_haContext, "binary_sensor.back_door_door");
    ///<summary>Colin&apos;s iPhone Focus</summary>
    public BinarySensorEntity ColinSIphoneFocus => new(_haContext, "binary_sensor.colin_s_iphone_focus");
    ///<summary>Deck Door</summary>
    public BinarySensorEntity Deckdoor => new(_haContext, "binary_sensor.deckdoor");
    ///<summary>Driveway Camera Audio Object Detected</summary>
    public BinarySensorEntity DrivewayCameraAudioObjectDetected => new(_haContext, "binary_sensor.driveway_camera_audio_object_detected");
    ///<summary>Driveway Camera Co Alarm Detected</summary>
    public BinarySensorEntity DrivewayCameraCoAlarmDetected => new(_haContext, "binary_sensor.driveway_camera_co_alarm_detected");
    ///<summary>Driveway Camera Is Dark</summary>
    public BinarySensorEntity DrivewayCameraIsDark => new(_haContext, "binary_sensor.driveway_camera_is_dark");
    ///<summary>Driveway Camera Motion</summary>
    public BinarySensorEntity DrivewayCameraMotion => new(_haContext, "binary_sensor.driveway_camera_motion");
    ///<summary>Driveway Camera Object Detected</summary>
    public BinarySensorEntity DrivewayCameraObjectDetected => new(_haContext, "binary_sensor.driveway_camera_object_detected");
    ///<summary>Driveway Camera Person Detected</summary>
    public BinarySensorEntity DrivewayCameraPersonDetected => new(_haContext, "binary_sensor.driveway_camera_person_detected");
    ///<summary>Driveway Camera Smoke Alarm Detected</summary>
    public BinarySensorEntity DrivewayCameraSmokeAlarmDetected => new(_haContext, "binary_sensor.driveway_camera_smoke_alarm_detected");
    ///<summary>Driveway Camera Vehicle Detected</summary>
    public BinarySensorEntity DrivewayCameraVehicleDetected => new(_haContext, "binary_sensor.driveway_camera_vehicle_detected");
    ///<summary>Door</summary>
    public BinarySensorEntity FrontDoor => new(_haContext, "binary_sensor.front_door");
    ///<summary>Front Door</summary>
    public BinarySensorEntity Frontdoor => new(_haContext, "binary_sensor.frontdoor");
    ///<summary>Justus’s iPhone Focus</summary>
    public BinarySensorEntity JustussIphoneFocus => new(_haContext, "binary_sensor.justuss_iphone_focus");
    ///<summary>RPi Power status</summary>
    public BinarySensorEntity RpiPowerStatus => new(_haContext, "binary_sensor.rpi_power_status");
    ///<summary>Sweepy Cleaning</summary>
    public BinarySensorEntity SweepyCleaning => new(_haContext, "binary_sensor.sweepy_cleaning");
    ///<summary>Sweepy Mop attached</summary>
    public BinarySensorEntity SweepyMopAttached => new(_haContext, "binary_sensor.sweepy_mop_attached");
    ///<summary>Sweepy Mop drying</summary>
    public BinarySensorEntity SweepyMopDrying => new(_haContext, "binary_sensor.sweepy_mop_drying");
    ///<summary>Sweepy Water box attached</summary>
    public BinarySensorEntity SweepyWaterBoxAttached => new(_haContext, "binary_sensor.sweepy_water_box_attached");
    ///<summary>Sweepy Water shortage</summary>
    public BinarySensorEntity SweepyWaterShortage => new(_haContext, "binary_sensor.sweepy_water_shortage");
    ///<summary>The Piney Switch Hdd 1</summary>
    public BinarySensorEntity ThePineySwitchHdd1 => new(_haContext, "binary_sensor.the_piney_switch_hdd_1");
    ///<summary>Updater</summary>
    public BinarySensorEntity Updater => new(_haContext, "binary_sensor.updater");
    ///<summary>Washer</summary>
    public BinarySensorEntity Water27 => new(_haContext, "binary_sensor.water_27");
    ///<summary>Water 27 Low Battery</summary>
    public BinarySensorEntity Water27LowBattery => new(_haContext, "binary_sensor.water_27_low_battery");
    ///<summary>Water 27 Tampered</summary>
    public BinarySensorEntity Water27Tampered => new(_haContext, "binary_sensor.water_27_tampered");
}
...
public partial class ButtonEntities
{
    ...
    ///<summary>Driveway Camera Reboot Device</summary>
    public ButtonEntity DrivewayCameraRebootDevice => new(_haContext, "button.driveway_camera_reboot_device");
    ///<summary>Sensi-0EF293 Identify</summary>
    public ButtonEntity Sensi0ef293Identify => new(_haContext, "button.sensi_0ef293_identify");
    ///<summary>The Piney Switch Restart</summary>
    public ButtonEntity ThePineySwitchRestart => new(_haContext, "button.the_piney_switch_restart");
    ///<summary>U6-Lite Restart</summary>
    public ButtonEntity U6LiteRestart => new(_haContext, "button.u6_lite_restart");
}
...
public partial class CameraEntities
{
    ...
    ///<summary>Driveway Camera</summary>
    public CameraEntity DrivewayCamera => new(_haContext, "camera.driveway_camera");
}
...
public partial class ClimateEntities
{
    ...
    ///<summary>Sensi-0EF293 Thermostat</summary>
...
public partial class DeviceTrackerEntities
{
    ...
    ///<summary>Colin’s iPad</summary>
    public DeviceTrackerEntity ColinsIpad => new(_haContext, "device_tracker.colins_ipad");
    ///<summary>Colin&apos;s iPhone</summary>
    public DeviceTrackerEntity ColinsIphone2 => new(_haContext, "device_tracker.colins_iphone_2");
    ///<summary>Colin</summary>
    public DeviceTrackerEntity ColinsIphoneGps => new(_haContext, "device_tracker.colins_iphone_gps");
    ///<summary>Colin&apos;s Macbook Pro</summary>
    public DeviceTrackerEntity ColinsMbp2 => new(_haContext, "device_tracker.colins_mbp_2");
    ///<summary>Colin’s Apple Watch</summary>
    public DeviceTrackerEntity Colinsaplewatch2 => new(_haContext, "device_tracker.colinsaplewatch_2");
    ///<summary>Home Assistant</summary>
    public DeviceTrackerEntity HomeAssistant => new(_haContext, "device_tracker.home_assistant");
    ///<summary>HMNTAR WIFI</summary>
    public DeviceTrackerEntity JustusPc => new(_haContext, "device_tracker.justus_pc");
    ///<summary>Justus’ iPhone</summary>
    public DeviceTrackerEntity JustussIphone => new(_haContext, "device_tracker.justuss_iphone");
    ///<summary>Justus’s iPhone</summary>
    public DeviceTrackerEntity JustussIphoneGps => new(_haContext, "device_tracker.justuss_iphone_gps");
    ///<summary>Litter Robot</summary>
    public DeviceTrackerEntity LitterRobot42 => new(_haContext, "device_tracker.litter_robot4_2");
    ///<summary>Living Room Apple TV</summary>
    public DeviceTrackerEntity LivingRoomTv2 => new(_haContext, "device_tracker.living_room_tv_2");
    ///<summary>Roborock Sweepy</summary>
    public DeviceTrackerEntity RoborockVacuumA65 => new(_haContext, "device_tracker.roborock_vacuum_a65");
    ///<summary>Master Bedroom TV</summary>
    public DeviceTrackerEntity Samsung2 => new(_haContext, "device_tracker.samsung_2");
    ///<summary>Sensi Thermostat</summary>
    public DeviceTrackerEntity Sensi0ef2932 => new(_haContext, "device_tracker.sensi_0ef293_2");
    ///<summary>The Piney Switch</summary>
    public DeviceTrackerEntity ThePineySwitch => new(_haContext, "device_tracker.the_piney_switch");
    ///<summary>Trevor&apos;s PC</summary>
    public DeviceTrackerEntity TrevorSPc => new(_haContext, "device_tracker.trevor_s_pc");
    ///<summary>U6-Lite</summary>
    public DeviceTrackerEntity U6Lite => new(_haContext, "device_tracker.u6_lite");
    ///<summary>Hue Bridge</summary>
    public DeviceTrackerEntity Unifi00178866FeFfDefault => new(_haContext, "device_tracker.unifi_00_17_88_66_fe_ff_default");
    ///<summary>HMNTAR</summary>
    public DeviceTrackerEntity Unifi2cF05d837963Default => new(_haContext, "device_tracker.unifi_2c_f0_5d_83_79_63_default");
    ///<summary>Colins PC</summary>
    public DeviceTrackerEntity Unifi3497F693D3C9Default => new(_haContext, "device_tracker.unifi_34_97_f6_93_d3_c9_default");
    ///<summary>Cat Feeder</summary>
    public DeviceTrackerEntity Unifi381f8d90518eDefault => new(_haContext, "device_tracker.unifi_38_1f_8d_90_51_8e_default");
    public DeviceTrackerEntity Unifi5c0cE6F461D4Default => new(_haContext, "device_tracker.unifi_5c_0c_e6_f4_61_d4_default");
    ///<summary>Trevor’s iPhone</summary>
    public DeviceTrackerEntity UnifiB8144dAaFf8cDefault => new(_haContext, "device_tracker.unifi_b8_14_4d_aa_ff_8c_default");
    public DeviceTrackerEntity UnifiBa24CaD8A48cDefault => new(_haContext, "device_tracker.unifi_ba_24_ca_d8_a4_8c_default");
    public DeviceTrackerEntity UnifiDefaultF4E2C664F7Dc => new(_haContext, "device_tracker.unifi_default_f4_e2_c6_64_f7_dc");
    ///<summary>Driveway Camera</summary>
    public DeviceTrackerEntity Uvc => new(_haContext, "device_tracker.uvc");
    ///<summary>Air Filter WEMO Switch</summary>
    public DeviceTrackerEntity Wemo3 => new(_haContext, "device_tracker.wemo_3");
    ///<summary>WYZE_CAKP2JFUS-7C78B293744B</summary>
    public DeviceTrackerEntity WyzeCakp2jfus7c78b293744b => new(_haContext, "device_tracker.wyze_cakp2jfus_7c78b293744b");
    ///<summary>WYZE_CAKP2JFUS-D03F274E6403</summary>
    public DeviceTrackerEntity WyzeCakp2jfusD03f274e6403 => new(_haContext, "device_tracker.wyze_cakp2jfus_d03f274e6403");
    ///<summary>WYZE_CAKP2JFUS-D03F274F3671</summary>
    public DeviceTrackerEntity WyzeCakp2jfusD03f274f3671 => new(_haContext, "device_tracker.wyze_cakp2jfus_d03f274f3671");
}
...
public partial class EventEntities
{
    ...
    ///<summary>Hue dimmer switch 1 Button 1</summary>
    public EventEntity HueDimmerSwitch1Button1 => new(_haContext, "event.hue_dimmer_switch_1_button_1");
    ///<summary>Hue dimmer switch 1 Button 2</summary>
    public EventEntity HueDimmerSwitch1Button2 => new(_haContext, "event.hue_dimmer_switch_1_button_2");
    ///<summary>Hue dimmer switch 1 Button 3</summary>
    public EventEntity HueDimmerSwitch1Button3 => new(_haContext, "event.hue_dimmer_switch_1_button_3");
    ///<summary>Hue dimmer switch 1 Button 4</summary>
    public EventEntity HueDimmerSwitch1Button4 => new(_haContext, "event.hue_dimmer_switch_1_button_4");
    ///<summary>Hue dimmer switch 2 Button 1</summary>
    public EventEntity HueDimmerSwitch2Button1 => new(_haContext, "event.hue_dimmer_switch_2_button_1");
    ///<summary>Hue dimmer switch 2 Button 2</summary>
    public EventEntity HueDimmerSwitch2Button2 => new(_haContext, "event.hue_dimmer_switch_2_button_2");
    ///<summary>Hue dimmer switch 2 Button 3</summary>
    public EventEntity HueDimmerSwitch2Button3 => new(_haContext, "event.hue_dimmer_switch_2_button_3");
    ///<summary>Hue dimmer switch 2 Button 4</summary>
    public EventEntity HueDimmerSwitch2Button4 => new(_haContext, "event.hue_dimmer_switch_2_button_4");
}
...
public partial class GroupEntities
{
    ...
    public GroupEntity NightstandLights => new(_haContext, "group.nightstand_lights");
    ///<summary>Outside Lights</summary>
    public GroupEntity OutsideLights => new(_haContext, "group.outside_lights");
}
...
public partial class ImageEntities
{
    ...
    ///<summary>Sweepy First Floor</summary>
    public ImageEntity SweepyFirstFloor => new(_haContext, "image.sweepy_first_floor");
    ///<summary>Sweepy Second Floor</summary>
    public ImageEntity SweepySecondFloor => new(_haContext, "image.sweepy_second_floor");
}
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>A/C</summary>
    public InputBooleanEntity AC => new(_haContext, "input_boolean.a_c");
    ///<summary>Bedroom Heater</summary>
    public InputBooleanEntity BedroomHeater => new(_haContext, "input_boolean.bedroom_heater");
    ///<summary>Cats Home</summary>
    public InputBooleanEntity CatsHome => new(_haContext, "input_boolean.cats_home");
    ///<summary>Doors Open</summary>
    public InputBooleanEntity Doors => new(_haContext, "input_boolean.doors");
    ...
    public InputBooleanEntity Heat => new(_haContext, "input_boolean.heat");
    ///<summary>home</summary>
    public InputBooleanEntity Home => new(_haContext, "input_boolean.home");
    ///<summary>Humidity</summary>
    public InputBooleanEntity Humidity => new(_haContext, "input_boolean.humidity");
    ///<summary>Prepare For Arrival</summary>
    public InputBooleanEntity PrepareForArrival => new(_haContext, "input_boolean.prepare_for_arrival");
    ///<summary>Security Armed</summary>
    public InputBooleanEntity SecurityArmed => new(_haContext, "input_boolean.security_armed");
...
public partial class InputNumberEntities
{
    ...
    ///<summary>A/C Set Temperature</summary>
    public InputNumberEntity ACSetTemperature => new(_haContext, "input_number.a_c_set_temperature");
}
...
public partial class LockEntities
{
    ...
    public LockEntity BackDoor => new(_haContext, "lock.back_door");
...
public partial class NumberEntities
{
    ...
    ///<summary>Driveway Camera Microphone Level</summary>
    public NumberEntity DrivewayCameraMicrophoneLevel => new(_haContext, "number.driveway_camera_microphone_level");
    ///<summary>Sweepy Volume</summary>
    public NumberEntity SweepyVolume => new(_haContext, "number.sweepy_volume");
}
...
public partial class PersonEntities
{
    ...
    ///<summary>Colin</summary>
    public PersonEntity Colin => new(_haContext, "person.colin");
    ///<summary>Colin</summary>
    public PersonEntity Colin2 => new(_haContext, "person.colin_2");
    ///<summary>Justus</summary>
    public PersonEntity Justus => new(_haContext, "person.justus");
    ///<summary>Justus</summary>
    public PersonEntity Justus2 => new(_haContext, "person.justus_2");
    ///<summary>mosquitto</summary>
    public PersonEntity Mosquitto => new(_haContext, "person.mosquitto");
    ///<summary>Trevor</summary>
    public PersonEntity Trevor => new(_haContext, "person.trevor");
    ///<summary>Trevor</summary>
    public PersonEntity Trevor2 => new(_haContext, "person.trevor_2");
}
...
public partial class SceneEntities
{
    ...
    ///<summary>Bedroom Concentrate</summary>
    public SceneEntity BedroomConcentrate => new(_haContext, "scene.bedroom_concentrate");
    ///<summary>Bedroom Dimmed</summary>
    public SceneEntity BedroomDimmed => new(_haContext, "scene.bedroom_dimmed");
    ...
    public SceneEntity Goodnight => new(_haContext, "scene.goodnight");
    ///<summary>Home</summary>
    public SceneEntity Home => new(_haContext, "scene.home");
    ///<summary>Late Night</summary>
    public SceneEntity LateNight => new(_haContext, "scene.late_night");
    ///<summary>Living Room Arctic aurora</summary>
    public SceneEntity LivingRoomArcticAurora => new(_haContext, "scene.living_room_arctic_aurora");
    ///<summary>Living Room Bright</summary>
    public SceneEntity LivingRoomBright => new(_haContext, "scene.living_room_bright");
    ///<summary>Living Room Concentrate</summary>
    public SceneEntity LivingRoomConcentrate => new(_haContext, "scene.living_room_concentrate");
    ///<summary>Living Room DANGER</summary>
    public SceneEntity LivingRoomDanger => new(_haContext, "scene.living_room_danger");
    ///<summary>Living Room Dimmed</summary>
    public SceneEntity LivingRoomDimmed => new(_haContext, "scene.living_room_dimmed");
    ///<summary>Living Room Energize</summary>
    public SceneEntity LivingRoomEnergize => new(_haContext, "scene.living_room_energize");
    ///<summary>Living Room Galaxy</summary>
    public SceneEntity LivingRoomGalaxy => new(_haContext, "scene.living_room_galaxy");
    ///<summary>Living Room Gaming</summary>
    public SceneEntity LivingRoomGaming => new(_haContext, "scene.living_room_gaming");
    ///<summary>Living Room Home</summary>
    public SceneEntity LivingRoomHome => new(_haContext, "scene.living_room_home");
    ///<summary>Living Room Home</summary>
    public SceneEntity LivingRoomHome2 => new(_haContext, "scene.living_room_home_2");
    ///<summary>Living Room Lamp only</summary>
    public SceneEntity LivingRoomLampOnly => new(_haContext, "scene.living_room_lamp_only");
    ///<summary>Living Room Midwinter</summary>
    public SceneEntity LivingRoomMidwinter => new(_haContext, "scene.living_room_midwinter");
    ///<summary>Living Room Moonlight</summary>
    public SceneEntity LivingRoomMoonlight => new(_haContext, "scene.living_room_moonlight");
    ...
    ///<summary>Living Room Read</summary>
    public SceneEntity LivingRoomRead => new(_haContext, "scene.living_room_read");
    ///<summary>Living Room Relax</summary>
    public SceneEntity LivingRoomRelax => new(_haContext, "scene.living_room_relax");
    ///<summary>Living Room Savanna sunset</summary>
    public SceneEntity LivingRoomSavannaSunset => new(_haContext, "scene.living_room_savanna_sunset");
    ///<summary>Living Room Spring blossom</summary>
    public SceneEntity LivingRoomSpringBlossom => new(_haContext, "scene.living_room_spring_blossom");
    ///<summary>Living Room Spring lake</summary>
    public SceneEntity LivingRoomSpringLake => new(_haContext, "scene.living_room_spring_lake");
    ///<summary>Living Room Tropical twilight</summary>
    public SceneEntity LivingRoomTropicalTwilight => new(_haContext, "scene.living_room_tropical_twilight");
    ///<summary>Main Lights Off</summary>
    public SceneEntity MainLightsOff => new(_haContext, "scene.main_lights_off");
    ///<summary>Movie</summary>
    public SceneEntity MovieLights => new(_haContext, "scene.movie_lights");
    ///<summary>Office Arctic aurora</summary>
    public SceneEntity OfficeArcticAurora => new(_haContext, "scene.office_arctic_aurora");
    ///<summary>Office Bright</summary>
    public SceneEntity OfficeBright => new(_haContext, "scene.office_bright");
    ///<summary>Office Concentrate</summary>
    public SceneEntity OfficeConcentrate => new(_haContext, "scene.office_concentrate");
    ///<summary>Office Dimmed</summary>
    public SceneEntity OfficeDimmed => new(_haContext, "scene.office_dimmed");
    ///<summary>Office Energize</summary>
    public SceneEntity OfficeEnergize => new(_haContext, "scene.office_energize");
    ///<summary>Office Nightlight</summary>
    public SceneEntity OfficeNightlight => new(_haContext, "scene.office_nightlight");
    ///<summary>Office Read</summary>
    public SceneEntity OfficeRead => new(_haContext, "scene.office_read");
    ///<summary>Office Relax</summary>
    public SceneEntity OfficeRelax => new(_haContext, "scene.office_relax");
    ///<summary>Office Savanna sunset</summary>
    public SceneEntity OfficeSavannaSunset => new(_haContext, "scene.office_savanna_sunset");
    ///<summary>Office Spring blossom</summary>
    public SceneEntity OfficeSpringBlossom => new(_haContext, "scene.office_spring_blossom");
    ///<summary>Office Tropical twilight</summary>
    public SceneEntity OfficeTropicalTwilight => new(_haContext, "scene.office_tropical_twilight");
...
public partial class ScriptEntities
{
    ...
    public ScriptEntity Newscript => new(_haContext, "script.newscript");
}
...
public partial class SelectEntities
{
    ...
    ///<summary>Driveway Camera Infrared Mode</summary>
    public SelectEntity DrivewayCameraInfraredMode => new(_haContext, "select.driveway_camera_infrared_mode");
    ///<summary>Driveway Camera Recording Mode</summary>
    public SelectEntity DrivewayCameraRecordingMode => new(_haContext, "select.driveway_camera_recording_mode");
    ///<summary>Sensi-0EF293 Temperature Display Units</summary>
    public SelectEntity Sensi0ef293TemperatureDisplayUnits => new(_haContext, "select.sensi_0ef293_temperature_display_units");
    ///<summary>Shit Hole Clean cycle wait time minutes</summary>
    public SelectEntity ShitHoleCleanCycleWaitTimeMinutes => new(_haContext, "select.shit_hole_clean_cycle_wait_time_minutes");
    ///<summary>Shit Hole Panel brightness</summary>
    public SelectEntity ShitHolePanelBrightness => new(_haContext, "select.shit_hole_panel_brightness");
    ///<summary>Sweepy Mop intensity</summary>
    public SelectEntity SweepyMopIntensity => new(_haContext, "select.sweepy_mop_intensity");
    ///<summary>Sweepy Mop mode</summary>
    public SelectEntity SweepyMopMode => new(_haContext, "select.sweepy_mop_mode");
}
...
public partial class SensorEntities
{
    ...
    ///<summary>Colin&apos;s iPhone Activity</summary>
    public SensorEntity ColinSIphoneActivity => new(_haContext, "sensor.colin_s_iphone_activity");
    ///<summary>Colin&apos;s iPhone Battery State</summary>
    public SensorEntity ColinSIphoneBatteryState => new(_haContext, "sensor.colin_s_iphone_battery_state");
    ///<summary>Colin&apos;s iPhone BSSID</summary>
    public SensorEntity ColinSIphoneBssid => new(_haContext, "sensor.colin_s_iphone_bssid");
    ///<summary>Colin&apos;s iPhone Connection Type</summary>
    public SensorEntity ColinSIphoneConnectionType => new(_haContext, "sensor.colin_s_iphone_connection_type");
    ///<summary>Colin&apos;s iPhone Geocoded Location</summary>
    public SensorEntity ColinSIphoneGeocodedLocation => new(_haContext, "sensor.colin_s_iphone_geocoded_location");
    ///<summary>Colin&apos;s iPhone Last Update Trigger</summary>
    public SensorEntity ColinSIphoneLastUpdateTrigger => new(_haContext, "sensor.colin_s_iphone_last_update_trigger");
    ///<summary>Colin&apos;s iPhone SIM 1</summary>
    public SensorEntity ColinSIphoneSim1 => new(_haContext, "sensor.colin_s_iphone_sim_1");
    ///<summary>Colin&apos;s iPhone SIM 2</summary>
    public SensorEntity ColinSIphoneSim2 => new(_haContext, "sensor.colin_s_iphone_sim_2");
    ///<summary>Colin&apos;s iPhone SSID</summary>
    public SensorEntity ColinSIphoneSsid => new(_haContext, "sensor.colin_s_iphone_ssid");
    ///<summary>Colin’s iPad Battery State</summary>
    public SensorEntity ColinsIpadBatteryState => new(_haContext, "sensor.colins_ipad_battery_state");
    ///<summary>Colin’s iPad BSSID</summary>
    public SensorEntity ColinsIpadBssid => new(_haContext, "sensor.colins_ipad_bssid");
    ///<summary>Colin’s iPad Connection Type</summary>
    public SensorEntity ColinsIpadConnectionType => new(_haContext, "sensor.colins_ipad_connection_type");
    ///<summary>Colin’s iPad Geocoded Location</summary>
    public SensorEntity ColinsIpadGeocodedLocation => new(_haContext, "sensor.colins_ipad_geocoded_location");
    ///<summary>Colin’s iPad Last Update Trigger</summary>
    public SensorEntity ColinsIpadLastUpdateTrigger => new(_haContext, "sensor.colins_ipad_last_update_trigger");
    ///<summary>Colin’s iPad SSID</summary>
    public SensorEntity ColinsIpadSsid => new(_haContext, "sensor.colins_ipad_ssid");
    ///<summary>Justus’s iPhone Activity</summary>
    public SensorEntity JustussIphoneActivity => new(_haContext, "sensor.justuss_iphone_activity");
    ///<summary>Justus’s iPhone Battery State</summary>
    public SensorEntity JustussIphoneBatteryState => new(_haContext, "sensor.justuss_iphone_battery_state");
    ///<summary>Justus’s iPhone BSSID</summary>
    public SensorEntity JustussIphoneBssid => new(_haContext, "sensor.justuss_iphone_bssid");
    ///<summary>Justus’s iPhone Connection Type</summary>
    public SensorEntity JustussIphoneConnectionType => new(_haContext, "sensor.justuss_iphone_connection_type");
    ///<summary>Justus’s iPhone Geocoded Location</summary>
    public SensorEntity JustussIphoneGeocodedLocation => new(_haContext, "sensor.justuss_iphone_geocoded_location");
    ///<summary>Justus’s iPhone Last Update Trigger</summary>
    public SensorEntity JustussIphoneLastUpdateTrigger => new(_haContext, "sensor.justuss_iphone_last_update_trigger");
    ///<summary>Justus’s iPhone SIM 1</summary>
    public SensorEntity JustussIphoneSim1 => new(_haContext, "sensor.justuss_iphone_sim_1");
    ///<summary>Justus’s iPhone SIM 2</summary>
    public SensorEntity JustussIphoneSim2 => new(_haContext, "sensor.justuss_iphone_sim_2");
    ///<summary>Justus’s iPhone SSID</summary>
    public SensorEntity JustussIphoneSsid => new(_haContext, "sensor.justuss_iphone_ssid");
    ///<summary>nws_0d_hightemp</summary>
    public SensorEntity Nws0dHightemp => new(_haContext, "sensor.nws_0d_hightemp");
    public SensorEntity Piney1 => new(_haContext, "sensor.piney_1");
    ///<summary>awifihasnoname</summary>
    public SensorEntity Piney12 => new(_haContext, "sensor.piney_1_2");
    public SensorEntity Piney2 => new(_haContext, "sensor.piney_2");
    ///<summary>Piney-2</summary>
    public SensorEntity Piney22 => new(_haContext, "sensor.piney_2_2");
    public SensorEntity Piney3 => new(_haContext, "sensor.piney_3");
    ///<summary>piney-iot</summary>
    public SensorEntity PineyIot => new(_haContext, "sensor.piney_iot");
    ///<summary>Shit Hole Last seen</summary>
    public SensorEntity ShitHoleLastSeen => new(_haContext, "sensor.shit_hole_last_seen");
    ///<summary>Shit Hole Sleep mode end time</summary>
    public SensorEntity ShitHoleSleepModeEndTime => new(_haContext, "sensor.shit_hole_sleep_mode_end_time");
    ///<summary>Shit Hole Sleep mode start time</summary>
    public SensorEntity ShitHoleSleepModeStartTime => new(_haContext, "sensor.shit_hole_sleep_mode_start_time");
    ///<summary>Shit Hole Status code</summary>
    public SensorEntity ShitHoleStatusCode => new(_haContext, "sensor.shit_hole_status_code");
    ...
    ///<summary>Sweepy Dock error</summary>
    public SensorEntity SweepyDockError => new(_haContext, "sensor.sweepy_dock_error");
    ///<summary>Sweepy Last clean begin</summary>
    public SensorEntity SweepyLastCleanBegin => new(_haContext, "sensor.sweepy_last_clean_begin");
    ///<summary>Sweepy Last clean end</summary>
    public SensorEntity SweepyLastCleanEnd => new(_haContext, "sensor.sweepy_last_clean_end");
    ///<summary>Sweepy Status</summary>
    public SensorEntity SweepyStatus => new(_haContext, "sensor.sweepy_status");
    ///<summary>Sweepy Vacuum error</summary>
    public SensorEntity SweepyVacuumError => new(_haContext, "sensor.sweepy_vacuum_error");
    ///<summary>The Piney Switch State</summary>
    public SensorEntity ThePineySwitchState => new(_haContext, "sensor.the_piney_switch_state");
    ///<summary>The Piney Switch Uptime</summary>
    public SensorEntity ThePineySwitchUptime => new(_haContext, "sensor.the_piney_switch_uptime");
    ///<summary>The Piney Switch Uptime</summary>
    public SensorEntity ThePineySwitchUptime2 => new(_haContext, "sensor.the_piney_switch_uptime_2");
    ///<summary>U6-Lite State</summary>
    public SensorEntity U6LiteState => new(_haContext, "sensor.u6_lite_state");
    ///<summary>U6-Lite Uptime</summary>
    public SensorEntity U6LiteUptime => new(_haContext, "sensor.u6_lite_uptime");
    ///<summary>Average House Humidity</summary>
    public NumericSensorEntity AverageHouseHumidity => new(_haContext, "sensor.average_house_humidity");
    ///<summary>Average House Temperature</summary>
    public NumericSensorEntity AverageHouseTemperature => new(_haContext, "sensor.average_house_temperature");
    ///<summary>Battery</summary>
    public NumericSensorEntity BackDoorBatteryLevel => new(_haContext, "sensor.back_door_battery_level");
    ///<summary>Basement</summary>
    public NumericSensorEntity BasementHumid => new(_haContext, "sensor.basement_humid");
    ///<summary>Basement Multi Battery</summary>
    public NumericSensorEntity BasementMultiBattery => new(_haContext, "sensor.basement_multi_battery");
    ///<summary>Basement</summary>
    public NumericSensorEntity BasementPressure => new(_haContext, "sensor.basement_pressure");
    ///<summary>Basement</summary>
    public NumericSensorEntity BasementTemp => new(_haContext, "sensor.basement_temp");
    ///<summary>Colin&apos;s iPhone Average Active Pace</summary>
    public NumericSensorEntity ColinSIphoneAverageActivePace => new(_haContext, "sensor.colin_s_iphone_average_active_pace");
    ///<summary>Colin&apos;s iPhone Battery Level</summary>
    public NumericSensorEntity ColinSIphoneBatteryLevel => new(_haContext, "sensor.colin_s_iphone_battery_level");
    ///<summary>Colin&apos;s iPhone Distance</summary>
    public NumericSensorEntity ColinSIphoneDistance => new(_haContext, "sensor.colin_s_iphone_distance");
    ///<summary>Colin&apos;s iPhone Floors Ascended</summary>
    public NumericSensorEntity ColinSIphoneFloorsAscended => new(_haContext, "sensor.colin_s_iphone_floors_ascended");
    ///<summary>Colin&apos;s iPhone Floors Descended</summary>
    public NumericSensorEntity ColinSIphoneFloorsDescended => new(_haContext, "sensor.colin_s_iphone_floors_descended");
    ///<summary>Colin&apos;s iPhone Steps</summary>
    public NumericSensorEntity ColinSIphoneSteps => new(_haContext, "sensor.colin_s_iphone_steps");
    ///<summary>Colin&apos;s iPhone Storage</summary>
    public NumericSensorEntity ColinSIphoneStorage => new(_haContext, "sensor.colin_s_iphone_storage");
    ///<summary>Colin’s iPad Battery Level</summary>
    public NumericSensorEntity ColinsIpadBatteryLevel => new(_haContext, "sensor.colins_ipad_battery_level");
    ///<summary>Colin’s iPad Storage</summary>
    public NumericSensorEntity ColinsIpadStorage => new(_haContext, "sensor.colins_ipad_storage");
    ///<summary>Connected clients</summary>
    public NumericSensorEntity ConnectedClients => new(_haContext, "sensor.connected_clients");
    ///<summary>Deck Door Sensor</summary>
    public NumericSensorEntity DeckdoorBattery => new(_haContext, "sensor.deckdoor_battery");
    ///<summary>Driveway Camera Disk Write Rate</summary>
    public NumericSensorEntity DrivewayCameraDiskWriteRate => new(_haContext, "sensor.driveway_camera_disk_write_rate");
    ///<summary>Driveway Camera Storage Used</summary>
    public NumericSensorEntity DrivewayCameraStorageUsed => new(_haContext, "sensor.driveway_camera_storage_used");
    ///<summary>First Floor</summary>
    public NumericSensorEntity FirstfloorHumid => new(_haContext, "sensor.firstfloor_humid");
    ///<summary>First Floor Pressure</summary>
    public NumericSensorEntity FirstfloorPress => new(_haContext, "sensor.firstfloor_press");
    ///<summary>First Floor</summary>
    public NumericSensorEntity FirstfloorTemp => new(_haContext, "sensor.firstfloor_temp");
    ///<summary>Battery</summary>
    public NumericSensorEntity FrontDoorBatteryLevel => new(_haContext, "sensor.front_door_battery_level");
    ///<summary>Deck Door Temperature</summary>
    public NumericSensorEntity FrontDoorTemperature => new(_haContext, "sensor.front_door_temperature");
    ///<summary>Front Door Sensor</summary>
    public NumericSensorEntity FrontdoorBattery => new(_haContext, "sensor.frontdoor_battery");
    ///<summary>Garage Door Sensor</summary>
    public NumericSensorEntity GaragedoorBattery => new(_haContext, "sensor.garagedoor_battery");
    ...
    public NumericSensorEntity HueDimmerSwitch2Battery => new(_haContext, "sensor.hue_dimmer_switch_2_battery");
    ///<summary>Second Floor Multi Battery</summary>
    public NumericSensorEntity Humidity14Battery => new(_haContext, "sensor.humidity_14_battery");
    ///<summary>First Floor Multi Battery</summary>
    public NumericSensorEntity Humidity17Battery => new(_haContext, "sensor.humidity_17_battery");
    ///<summary>Justus’s iPhone Average Active Pace</summary>
    public NumericSensorEntity JustussIphoneAverageActivePace => new(_haContext, "sensor.justuss_iphone_average_active_pace");
    ///<summary>Justus’s iPhone Battery Level</summary>
    public NumericSensorEntity JustussIphoneBatteryLevel => new(_haContext, "sensor.justuss_iphone_battery_level");
    ///<summary>Justus’s iPhone Distance</summary>
    public NumericSensorEntity JustussIphoneDistance => new(_haContext, "sensor.justuss_iphone_distance");
    ///<summary>Justus’s iPhone Floors Ascended</summary>
    public NumericSensorEntity JustussIphoneFloorsAscended => new(_haContext, "sensor.justuss_iphone_floors_ascended");
    ///<summary>Justus’s iPhone Floors Descended</summary>
    public NumericSensorEntity JustussIphoneFloorsDescended => new(_haContext, "sensor.justuss_iphone_floors_descended");
    ///<summary>Justus’s iPhone Steps</summary>
    public NumericSensorEntity JustussIphoneSteps => new(_haContext, "sensor.justuss_iphone_steps");
    ///<summary>Justus’s iPhone Storage</summary>
    public NumericSensorEntity JustussIphoneStorage => new(_haContext, "sensor.justuss_iphone_storage");
    ///<summary>Living/Kitchen</summary>
    public NumericSensorEntity LivingKitchenHumid => new(_haContext, "sensor.living_kitchen_humid");
    ///<summary>Living/Kitchen Pressure</summary>
    public NumericSensorEntity LivingKitchenPress => new(_haContext, "sensor.living_kitchen_press");
    ///<summary>Living/Kitchen</summary>
    public NumericSensorEntity LivingKitchenTemp => new(_haContext, "sensor.living_kitchen_temp");
    ///<summary>Back Door Temperature</summary>
    public NumericSensorEntity Openclose7Temperature => new(_haContext, "sensor.openclose_7_temperature");
    ///<summary>Second Floor</summary>
    public NumericSensorEntity SecondfloorHumid => new(_haContext, "sensor.secondfloor_humid");
    ///<summary>Second Floor Pressure</summary>
    public NumericSensorEntity SecondfloorPressure => new(_haContext, "sensor.secondfloor_pressure");
    ///<summary>Second Floor</summary>
    public NumericSensorEntity SecondfloorTemp => new(_haContext, "sensor.secondfloor_temp");
    ///<summary>Sensi-0EF293 Current Temperature</summary>
    public NumericSensorEntity Sensi0ef293CurrentTemperature => new(_haContext, "sensor.sensi_0ef293_current_temperature");
    ///<summary>Shit Hole Litter level</summary>
    public NumericSensorEntity ShitHoleLitterLevel => new(_haContext, "sensor.shit_hole_litter_level");
    ///<summary>Shit Hole Pet weight</summary>
    public NumericSensorEntity ShitHolePetWeight => new(_haContext, "sensor.shit_hole_pet_weight");
    ///<summary>Shit Hole Waste drawer</summary>
    public NumericSensorEntity ShitHoleWasteDrawer => new(_haContext, "sensor.shit_hole_waste_drawer");
    ///<summary>Front Door Temperature</summary>
    public NumericSensorEntity SlidingDoorTemperature => new(_haContext, "sensor.sliding_door_temperature");
    ...
    ///<summary>Sweepy Battery</summary>
    public NumericSensorEntity SweepyBattery => new(_haContext, "sensor.sweepy_battery");
    ///<summary>Sweepy Cleaning area</summary>
    public NumericSensorEntity SweepyCleaningArea => new(_haContext, "sensor.sweepy_cleaning_area");
    ///<summary>Sweepy Cleaning progress</summary>
    public NumericSensorEntity SweepyCleaningProgress => new(_haContext, "sensor.sweepy_cleaning_progress");
    ///<summary>Sweepy Cleaning time</summary>
    public NumericSensorEntity SweepyCleaningTime => new(_haContext, "sensor.sweepy_cleaning_time");
    ///<summary>Sweepy Filter time left</summary>
    public NumericSensorEntity SweepyFilterTimeLeft => new(_haContext, "sensor.sweepy_filter_time_left");
    ///<summary>Sweepy Main brush time left</summary>
    public NumericSensorEntity SweepyMainBrushTimeLeft => new(_haContext, "sensor.sweepy_main_brush_time_left");
    ///<summary>Sweepy Mop drying remaining time</summary>
    public NumericSensorEntity SweepyMopDryingRemainingTime => new(_haContext, "sensor.sweepy_mop_drying_remaining_time");
    ///<summary>Sweepy Sensor time left</summary>
    public NumericSensorEntity SweepySensorTimeLeft => new(_haContext, "sensor.sweepy_sensor_time_left");
    ///<summary>Sweepy Side brush time left</summary>
    public NumericSensorEntity SweepySideBrushTimeLeft => new(_haContext, "sensor.sweepy_side_brush_time_left");
    ///<summary>Sweepy Total cleaning area</summary>
    public NumericSensorEntity SweepyTotalCleaningArea => new(_haContext, "sensor.sweepy_total_cleaning_area");
    ///<summary>Sweepy Total cleaning time</summary>
    public NumericSensorEntity SweepyTotalCleaningTime => new(_haContext, "sensor.sweepy_total_cleaning_time");
    ///<summary>Living/Kitchen Multi Battery</summary>
    public NumericSensorEntity Temperature23Battery => new(_haContext, "sensor.temperature_23_battery");
    ///<summary>The Piney Switch Recording Capacity</summary>
    public NumericSensorEntity ThePineySwitchRecordingCapacity => new(_haContext, "sensor.the_piney_switch_recording_capacity");
    ///<summary>The Piney Switch Resolution: 4K Video</summary>
    public NumericSensorEntity ThePineySwitchResolution4kVideo => new(_haContext, "sensor.the_piney_switch_resolution_4k_video");
    ///<summary>The Piney Switch Resolution: Free Space</summary>
    public NumericSensorEntity ThePineySwitchResolutionFreeSpace => new(_haContext, "sensor.the_piney_switch_resolution_free_space");
    ///<summary>The Piney Switch Resolution: Hd Video</summary>
    public NumericSensorEntity ThePineySwitchResolutionHdVideo => new(_haContext, "sensor.the_piney_switch_resolution_hd_video");
    ///<summary>The Piney Switch Storage Utilization</summary>
    public NumericSensorEntity ThePineySwitchStorageUtilization => new(_haContext, "sensor.the_piney_switch_storage_utilization");
    ///<summary>The Piney Switch Type: Continuous Video</summary>
    public NumericSensorEntity ThePineySwitchTypeContinuousVideo => new(_haContext, "sensor.the_piney_switch_type_continuous_video");
    ///<summary>The Piney Switch Type: Detections Video</summary>
    public NumericSensorEntity ThePineySwitchTypeDetectionsVideo => new(_haContext, "sensor.the_piney_switch_type_detections_video");
    ///<summary>The Piney Switch Type: Timelapse Video</summary>
    public NumericSensorEntity ThePineySwitchTypeTimelapseVideo => new(_haContext, "sensor.the_piney_switch_type_timelapse_video");
    ///<summary>Washer Battery</summary>
    public NumericSensorEntity Water27Battery => new(_haContext, "sensor.water_27_battery");
    ///<summary>Washer Temperature</summary>
    public NumericSensorEntity Water27Temperature => new(_haContext, "sensor.water_27_temperature");
}
...
public partial class SwitchEntities
{
    ...
    public SwitchEntity AirFilter => new(_haContext, "switch.air_filter");
    ///<summary>Automation: Night</summary>
    public SwitchEntity AutomationNight => new(_haContext, "switch.automation_night");
    ///<summary>Automation: Off</summary>
    public SwitchEntity AutomationOff => new(_haContext, "switch.automation_off");
    ///<summary>Automation: Off.2</summary>
    public SwitchEntity AutomationOff2 => new(_haContext, "switch.automation_off_2");
    ///<summary>Heater</summary>
    public SwitchEntity BedroomHeater => new(_haContext, "switch.bedroom_heater");
    ///<summary>Dehumidifier</summary>
    public SwitchEntity Dehumidifier => new(_haContext, "switch.dehumidifier");
    ///<summary>Driveway Camera Detections: Motion</summary>
    public SwitchEntity DrivewayCameraDetectionsMotion => new(_haContext, "switch.driveway_camera_detections_motion");
    ///<summary>Driveway Camera Detections: Person</summary>
    public SwitchEntity DrivewayCameraDetectionsPerson => new(_haContext, "switch.driveway_camera_detections_person");
    ///<summary>Driveway Camera Detections: Smoke/CO</summary>
    public SwitchEntity DrivewayCameraDetectionsSmokeCo => new(_haContext, "switch.driveway_camera_detections_smoke_co");
    ///<summary>Driveway Camera Detections: Vehicle</summary>
    public SwitchEntity DrivewayCameraDetectionsVehicle => new(_haContext, "switch.driveway_camera_detections_vehicle");
    ///<summary>Driveway Camera HDR Mode</summary>
    public SwitchEntity DrivewayCameraHdrMode => new(_haContext, "switch.driveway_camera_hdr_mode");
    ///<summary>Driveway Camera Overlay: Show Date</summary>
    public SwitchEntity DrivewayCameraOverlayShowDate => new(_haContext, "switch.driveway_camera_overlay_show_date");
    ///<summary>Driveway Camera Overlay: Show Logo</summary>
    public SwitchEntity DrivewayCameraOverlayShowLogo => new(_haContext, "switch.driveway_camera_overlay_show_logo");
    ///<summary>Driveway Camera Overlay: Show Name</summary>
    public SwitchEntity DrivewayCameraOverlayShowName => new(_haContext, "switch.driveway_camera_overlay_show_name");
    ///<summary>Driveway Camera Overlay: Show Nerd Mode</summary>
    public SwitchEntity DrivewayCameraOverlayShowNerdMode => new(_haContext, "switch.driveway_camera_overlay_show_nerd_mode");
    ///<summary>Driveway Camera Privacy Mode</summary>
    public SwitchEntity DrivewayCameraPrivacyMode => new(_haContext, "switch.driveway_camera_privacy_mode");
    ///<summary>Nightstand</summary>
    public SwitchEntity Nightstand => new(_haContext, "switch.nightstand");
    public SwitchEntity Piney1 => new(_haContext, "switch.piney_1");
    ///<summary>awifihasnoname</summary>
    public SwitchEntity Piney12 => new(_haContext, "switch.piney_1_2");
    public SwitchEntity Piney2 => new(_haContext, "switch.piney_2");
    ///<summary>Piney-2</summary>
    public SwitchEntity Piney22 => new(_haContext, "switch.piney_2_2");
    public SwitchEntity Piney3 => new(_haContext, "switch.piney_3");
    ///<summary>piney-iot</summary>
    public SwitchEntity PineyIot => new(_haContext, "switch.piney_iot");
    ///<summary>Shit Hole Night light mode</summary>
    public SwitchEntity ShitHoleNightLightMode => new(_haContext, "switch.shit_hole_night_light_mode");
    ///<summary>Shit Hole Panel lockout</summary>
    public SwitchEntity ShitHolePanelLockout => new(_haContext, "switch.shit_hole_panel_lockout");
    ///<summary>Sweepy Child lock</summary>
    public SwitchEntity SweepyChildLock => new(_haContext, "switch.sweepy_child_lock");
    ///<summary>Sweepy Do not disturb</summary>
    public SwitchEntity SweepyDoNotDisturb => new(_haContext, "switch.sweepy_do_not_disturb");
    ///<summary>The Piney Switch Analytics Enabled</summary>
    public SwitchEntity ThePineySwitchAnalyticsEnabled => new(_haContext, "switch.the_piney_switch_analytics_enabled");
    ///<summary>The Piney Switch Insights Enabled</summary>
    public SwitchEntity ThePineySwitchInsightsEnabled => new(_haContext, "switch.the_piney_switch_insights_enabled");
    ///<summary>UniFi Network Wiregaurd</summary>
    public SwitchEntity UnifiNetworkWiregaurd => new(_haContext, "switch.unifi_network_wiregaurd");
}
...
public partial class TimeEntities
{
    ...
    ///<summary>Sweepy Do not disturb begin</summary>
    public TimeEntity SweepyDoNotDisturbBegin => new(_haContext, "time.sweepy_do_not_disturb_begin");
    ///<summary>Sweepy Do not disturb end</summary>
    public TimeEntity SweepyDoNotDisturbEnd => new(_haContext, "time.sweepy_do_not_disturb_end");
}
...
public partial class UpdateEntities
{
    ...
    ///<summary>Bookstack Update</summary>
    public UpdateEntity BookstackUpdate => new(_haContext, "update.bookstack_update");
    ...
    ///<summary>deCONZ Update</summary>
    public UpdateEntity DeconzUpdate => new(_haContext, "update.deconz_update");
    ...
    ///<summary>Frigate Update</summary>
    public UpdateEntity FrigateUpdate2 => new(_haContext, "update.frigate_update_2");
    ///<summary>GitHub Dark Theme update</summary>
    public UpdateEntity GithubDarkThemeUpdate => new(_haContext, "update.github_dark_theme_update");
    ///<summary>go2rtc Update</summary>
    public UpdateEntity Go2rtcUpdate => new(_haContext, "update.go2rtc_update");
    ...
    ///<summary>HTML Jinja2 Template card update</summary>
    public UpdateEntity HtmlJinja2TemplateCardUpdate => new(_haContext, "update.html_jinja2_template_card_update");
    ...
    ///<summary>Shit Hole Firmware</summary>
    public UpdateEntity ShitHoleFirmware => new(_haContext, "update.shit_hole_firmware");
    ...
    ///<summary>Simple Weather Card update</summary>
    public UpdateEntity SimpleWeatherCardUpdate => new(_haContext, "update.simple_weather_card_update");
    ...
    ///<summary>Sundown Theme update</summary>
    public UpdateEntity SundownThemeUpdate => new(_haContext, "update.sundown_theme_update");
    ///<summary>The Piney Switch</summary>
    public UpdateEntity ThePineySwitch => new(_haContext, "update.the_piney_switch");
    ///<summary>Transparent Blue update</summary>
    public UpdateEntity TransparentBlueUpdate => new(_haContext, "update.transparent_blue_update");
    ///<summary>U6-Lite</summary>
    public UpdateEntity U6Lite => new(_haContext, "update.u6_lite");
    ///<summary>Vibrant (Dark) Clear Theme update</summary>
    public UpdateEntity VibrantDarkClearThemeUpdate => new(_haContext, "update.vibrant_dark_clear_theme_update");
...
public partial class VacuumEntities
{
    ...
    ///<summary>Shit Hole Litter box</summary>
    public VacuumEntity ShitHoleLitterBox => new(_haContext, "vacuum.shit_hole_litter_box");
    ///<summary>Sweepy</summary>
    public VacuumEntity Sweepy => new(_haContext, "vacuum.sweepy");
}
...
public partial class WeatherEntities
{
    ...
    ///<summary>KNHK Daynight</summary>
    public WeatherEntity KnhkDaynight => new(_haContext, "weather.knhk_daynight");
    ///<summary>KNHK Hourly</summary>
    public WeatherEntity KnhkHourly => new(_haContext, "weather.knhk_hourly");
}
...
public partial class ZoneEntities
{
    ...
    ///<summary>Avalon</summary>
    public ZoneEntity Avalon => new(_haContext, "zone.avalon");
    ///<summary>Hockessin</summary>
    public ZoneEntity Hockessin => new(_haContext, "zone.hockessin");
    ///<summary>Home</summary>
    public ZoneEntity Home => new(_haContext, "zone.home");
    ///<summary>NGC</summary>
    public ZoneEntity Ngc => new(_haContext, "zone.ngc");
    ///<summary>On Base</summary>
    public ZoneEntity PaxRiver => new(_haContext, "zone.pax_river");
}
...
public partial record VacuumAttributes
{
    ...
    [JsonPropertyName("is_sleeping")]
    public bool? IsSleeping { get; init; }

    [JsonPropertyName("sleep_mode_enabled")]
...
public interface IServices
{
    ...
    LitterrobotServices Litterrobot { get; }
...
public partial class Services : IServices
{
    ...
    public LitterrobotServices Litterrobot => new(_haContext);
...
public partial class DeconzServices
{
    private readonly IHaContext _haContext;
    public DeconzServices(IHaContext haContext)
    {
        _haContext = haContext;
    }

    ///<summary>Configures attributes of either a device endpoint in deCONZ or the deCONZ service itself.</summary>
    ...
    ///<summary>Refreshes available devices from deCONZ.</summary>
    ...
    ///<summary>Cleans up device and entity registry entries orphaned by deCONZ.</summary>
...
public partial record DeconzConfigureParameters
{
...
public partial record DeconzDeviceRefreshParameters
{
    ///<summary>Unique string for each deCONZ hardware. It can be found as part of the integration name. Useful if you run multiple deCONZ integrations. eg: 00212EFFFF012345</summary>
    [JsonPropertyName("bridgeid")]
    public string? Bridgeid { get; init; }
...
public partial record DeconzRemoveOrphanedEntriesParameters
{
    ///<summary>Unique string for each deCONZ hardware. It can be found as part of the integration name. Useful if you run multiple deCONZ integrations. eg: 00212EFFFF012345</summary>
    [JsonPropertyName("bridgeid")]
    public string? Bridgeid { get; init; }
...
public partial class LitterrobotServices
{
    private readonly IHaContext _haContext;
    public LitterrobotServices(IHaContext haContext)
    {
        _haContext = haContext;
    }

    ///<summary>Sets the sleep mode and start time.</summary>
    ///<param name="target">The target for this service call</param>
    public void SetSleepMode(ServiceTarget target, LitterrobotSetSleepModeParameters data)
    {
        _haContext.CallService("litterrobot", "set_sleep_mode", target, data);
    }

    ///<summary>Sets the sleep mode and start time.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="enabled">Whether sleep mode should be enabled.</param>
    ///<param name="startTime">The start time at which the Litter-Robot will enter sleep mode and prevent an automatic clean cycle for 8 hours. eg: &quot;22:30:00&quot;</param>
    public void SetSleepMode(ServiceTarget target, bool enabled, DateTime? startTime = null)
    {
        _haContext.CallService("litterrobot", "set_sleep_mode", target, new LitterrobotSetSleepModeParameters { Enabled = enabled, StartTime = startTime });
    }
}

public partial record LitterrobotSetSleepModeParameters
{
    ///<summary>Whether sleep mode should be enabled.</summary>
    [JsonPropertyName("enabled")]
    public bool? Enabled { get; init; }

    ///<summary>The start time at which the Litter-Robot will enter sleep mode and prevent an automatic clean cycle for 8 hours. eg: &quot;22:30:00&quot;</summary>
...
public partial class NotifyServices
{
    ...
    ///<summary>Sends a notification message using the mobile_app_colin_s_iphone integration.</summary>
    public void MobileAppColinSIphone(NotifyMobileAppColinSIphoneParameters data)
    {
        _haContext.CallService("notify", "mobile_app_colin_s_iphone", null, data);
    }
    ...
    public void MobileAppColinSIphone(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_colin_s_iphone", null, new NotifyMobileAppColinSIphoneParameters { Message = message, Title = title, Target = target, Data = data });
    }

    ///<summary>Sends a notification message using the mobile_app_colins_ipad integration.</summary>
    public void MobileAppColinsIpad(NotifyMobileAppColinsIpadParameters data)
    {
        _haContext.CallService("notify", "mobile_app_colins_ipad", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppColinsIpad(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_colins_ipad", null, new NotifyMobileAppColinsIpadParameters { Message = message, Title = title, Target = target, Data = data });
    }

    ///<summary>Sends a notification message using the mobile_app_colins_macbook_pro integration.</summary>
    public void MobileAppColinsMacbookPro(NotifyMobileAppColinsMacbookProParameters data)
    {
        _haContext.CallService("notify", "mobile_app_colins_macbook_pro", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppColinsMacbookPro(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_colins_macbook_pro", null, new NotifyMobileAppColinsMacbookProParameters { Message = message, Title = title, Target = target, Data = data });
    }

    ///<summary>Sends a notification message using the mobile_app_justuss_iphone integration.</summary>
    public void MobileAppJustussIphone(NotifyMobileAppJustussIphoneParameters data)
    {
        _haContext.CallService("notify", "mobile_app_justuss_iphone", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void MobileAppJustussIphone(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "mobile_app_justuss_iphone", null, new NotifyMobileAppJustussIphoneParameters { Message = message, Title = title, Target = target, Data = data });
    }
...
public partial record NotifyMobileAppColinSIphoneParameters
{
...
public partial record NotifyMobileAppColinsIpadParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial record NotifyMobileAppColinsMacbookProParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial record NotifyMobileAppJustussIphoneParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial class ScriptServices
{
    ...
    {
        _haContext.CallService("script", "newscript", null);
    }
...
public static class VacuumEntityExtensionMethods
{
    ...
    ///<summary>Toggles the vacuum cleaner on/off.</summary>
    public static void Toggle(this IVacuumEntityCore target)
    {
        target.CallService("toggle");
    }

    ///<summary>Toggles the vacuum cleaner on/off.</summary>
    public static void Toggle(this IEnumerable<IVacuumEntityCore> target)
    {
        target.CallService("toggle");
    }
